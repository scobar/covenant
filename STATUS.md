...
- Three original founding answers and three separately labeled,
  ...
  historical evidence.
- Provisional Moral Kernel Evaluation Framework v0.1 committed.
...
- AC-004 through AC-006 were evaluated without architect-prescribed outcomes.
- AC-004 records `Survives with reservation`; AC-005 and AC-006 each record
  `Fails current test`.
...
- Public trial-preparation manifest completed and audited:
  ...
  - Byte count: `7057`
- D-024 is accepted.
- TR-001 technical-invalidity and closure record created.
- TR-001 closure manifest completed and audited:
  - Raw SHA-256:
    `14f63fe64b22737a3a7bf2b624b1092312bc7ea01eebbffc560224e8dfb54fe4`
  - Git blob: `aef3fcc0936190ea589f0483ad393356462dba06`
  - Byte count: `1938`
- HO-001 classified as known Anthropic provider-side exposure.
- HO-002 private design and scorecard frozen before stream generation.
- HO-002 stream reconstructed exactly from the frozen private design.
- HO-002 public commitment created:
  `c8103cd2e80a2dc49309f1e1186817a75d97b8338950d726ffbc85e1127249b9`
- HO-002 public manifest completed and audited:
  - Raw SHA-256:
    `f0bef4fa203caa56b747164ae64015255662d48aa97b0a3ef7ab48c0be0582b6`
  - Git blob: `135e034f3cb7d12eb00ba6436d71e81efa62c845`
  - Byte count: `3806`
- At the preparation checkpoint, HO-002 was committed, backed up, and never
  supplied.
...
- Public TR-002 preparation manifest completed and audited:
  ...
  - Byte count: `7615`
- D-026 accepted.
- TR-002 closed complete.
- Two run attempts: one technical invalidity, one valid prior-exposed output.
- Score frozen and audited.
- Level 0 — Recovered.
- Level 1 — Not recovered.
- Level 2 — Partially recovered.
- Level 3 — Not recovered.
- Level 4 — Not recovered.
- No aggregate; Levels 5–9 unscored.
- HO-002 commitment verified 8/8.
- TR-002 packet commitment verified 7/7.
- Packet/source equality 2/2.
- Score immutability PASS.
- Reveal audit PASS exact agreement.
- Post-reveal backup reported verified.
- Public result record and manifest completed.
- Public result manifest identity:
  - Raw SHA-256:
...
- Public SDR-003 preparation-manifest identity:
  ...
  - Byte count: `3510`
- D-032 accepted.
- PTR-001 v0.1 and paired-trial package `SDR-003-PH-001-PT-001`
  created.
- Google Gemini web app selected.
- Displayed model `3.1 Pro` with Extended Thinking selected for both opaque
  conditions under the observed Google AI Plus (2TB) plan.
- Exact user-observed qualification block frozen.
- Two condition packets and three scoring sources copied and verified exactly.
- One private random opaque execution order frozen.
- Execution, evidence, validity, exposure, contamination, retry, isolated
  scoring, comparison, unblinding, stop, and dormancy protocols frozen.
- Private PTR-001 files: `25`; private manifest dependencies: `23`.
- Public PTR-001 preparation commitment:
  `1de6dcbed650450b046a950d87e989370601249ac2bd7a98f6dffeddf9a5184a`.
- Public PTR-001 preparation-manifest identity:
  - Raw SHA-256:
...
- SIG-001-HO-001 exposure: `Known Anthropic provider-side exposure`
- SIG-001-HO-002 lifecycle: `Sealed and committed`
- SIG-001-HO-002 exposure: `Known Anthropic provider-side exposure`
- No aggregate empirical decode rate exists.
...
- Lifecycle: `Closed incomplete — technical invalidity`.
- Run attempts: `1`.
- Valid outputs: `0`.
- Technical retry used: no.
- Technical retry: retired unused.
- Reveal: none.
- Private provider-visible partial trace: preserved as non-scorable incident
  evidence.
- HO-001 exposure: known Anthropic provider-side exposure.

### TR-002

- Lifecycle: `Closed complete — valid prior-exposed result`.
- Provider: Anthropic.
...
- Run attempts: `2`.
- Valid outputs: `1`.
- Technical retry used and exhausted.
- Validity and exposure class: `Valid — prior-exposed`.
- Level 0 — Recovered.
- Level 1 — Not recovered.
- Level 2 — Partially recovered.
- Level 3 — Not recovered.
...
- HO-002 and TR-002 packet commitments verified.
- Public raw output: not published.
...
- Intended levels: `0–4`.
- Exposure: known Anthropic provider-side exposure.
- Trial: TR-002 closed complete with a valid prior-exposed result.
- Selected displayed configuration: Anthropic Sonnet 5 / High.
- Valid outputs: `1`.
- Frozen scores: `1`.
- Private reveal-stage verifications: `1`.
- Public raw-output reveals: `0`.
- Prospective Sonnet 5 / High qualification preceded generation.
- Model-selection-blind chronology is not claimed.
...
| `cases/MK-0.1/scenarios/SC-004-voluntary-integration-control.md` | Frozen hypothetical scenario input — noncanonical |
| `cases/MK-0.1/scenarios/SC-005-unavoidable-scarcity.md` | Frozen hypothetical scenario input — noncanonical |
| `cases/MK-0.1/scenarios/SC-006-ac003-reanalysis-input.md` | Frozen hypothetical scenario input — noncanonical |
...
| `beacon/trials/SIG-001-HO-002-TR-002/00-PUBLIC-TRIAL-CHARTER.md` | Frozen pre-execution Sonnet 5 / High trial charter — noncanonical |
...
| `beacon/trials/SIG-001-HO-002-TR-002/02-EXECUTION-AND-FREEZE-PROTOCOL.md` | Frozen pre-execution browser execution and output-freeze protocol |
...
| `beacon/trials/SIG-001-HO-002-TR-002/04-PUBLIC-TRIAL-PREPARATION-MANIFEST.md` | Frozen four-row pre-execution TR-002 preparation manifest — noncanonical |
| `beacon/trials/SIG-001-HO-002-TR-002/05-PUBLIC-RESULT-AND-CLOSURE-RECORD.md` | Nonrevealing frozen TR-002 result and closed-complete record |
| `beacon/trials/SIG-001-HO-002-TR-002/06-PUBLIC-RESULT-MANIFEST.md` | Frozen one-row TR-002 public result manifest |
