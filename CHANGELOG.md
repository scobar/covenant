...
- Verbatim founding statements.
- Draft placeholders for the moral kernel, definitions, adversarial casebook,
  interpretive layers, choice protocol, Beacon specification, and
  evidence/governance.
- Initial project decision log.
...
- Adversarial case template now records exact candidate identity,
  interpretations, diagnoses, evidence, and outcomes.
